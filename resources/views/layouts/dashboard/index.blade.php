                    ...
                    <div class="px-6 mt-8">
                        <nav class=" w-full flex flex-col sidebar-nav">
                            <ul id="sidebarnav" class="text-gray-600 text-sm">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("components/buttons.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("components/alerts.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("components/cards.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("components/forms.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("components/typography.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("pages/authentication-login.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("pages/authentication-register.html")}}>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500"
                                        href={{asset("pages/sample-page.html")}}>
                ...
                {{-- <header class="container full-container w-full text-sm py-5 xl:px-9 px-5">
                    ...
                    <nav class=" w-full bg-gray-800  flex items-center justify-between" aria-label="Global">
                        ...
                        <div class="flex items-center gap-4">
                            <a href="#" class="btn font-medium hover:bg-blue-700 py-2" aria-current="page">Download
                                Free</a>
                            <div
                    ...
                    {{-- <div class="container full-container py-5 flex flex-col gap-6">
                                            ...
                                            <table class="text-left w-full whitespace-nowrap text-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="p-4">
                                                            <span
                                                                class="font-semibold text-base text-gray-600">$3.9</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="p-4">
                                                            <span
                                                                class="font-semibold text-base text-gray-600">$24.5k</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="p-4">
                                                            <span
                                                                class="font-semibold text-base text-gray-600">$12.8k</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="p-4">
                                                            <span
                                                                class="font-semibold text-base text-gray-600">$2.4k</span>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-2 gap-6">
                            <div class="card overflow-hidden">
                                <div class="relative">
                                    <a href="javascript:void(0)">
                                        <img src={{asset("assets/images/products/product-1.jpg")}} alt="product_img"
                                            class="w-full">
                                    </a>
                                    <a href="javascript:void(0)"
                            ...
                            <div class="card overflow-hidden">
                                <div class="relative">
                                    <a href="javascript:void(0)">
                                        <img src={{asset("assets/images/products/product-2.jpg")}} alt="product_img"
                                            class="w-full">
                                    </a>
                                    <a href="javascript:void(0)"
                                        class="bg-blue-600 w-8 h-8 flex justify-center items-center text-white rounded-full absolute bottom-0 right-0 mr-4 -mb-3">
                            ...
                            <div class="card overflow-hidden">
                                <div class="relative">
                                    <a href="javascript:void(0)">
                                        <img src={{asset("assets/images/products/product-3.jpg")}} alt="product_img"
                                            class="w-full">
                                    </a>
                                    <a href="javascript:void(0)"
                                        class="bg-blue-600 w-8 h-8 flex justify-center items-center text-white rounded-full absolute bottom-0 right-0 mr-4 -mb-3">
                            ...
                            <div class="card overflow-hidden">
                                <div class="relative">
                                    <a href="javascript:void(0)">
                                        <img src={{asset("assets/images/products/product-4.jpg")}} alt="product_img"
                                            class="w-full">
                                    </a>
                                    <a href="javascript:void(0)"
                                        class="bg-blue-600 w-8 h-8 flex justify-center items-center text-white rounded-full absolute bottom-0 right-0 mr-4 -mb-3">
