<aside id="application-sidebar-brand"
                class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full  transform  xl:block xl:translate-x-0 xl:end-auto xl:bottom-0 fixed top-0 with-vertical h-screen z-[999] flex-shrink-0 border-r-[1px] w-[270px] border-gray-200  bg-white left-sidebar   transition-all duration-300">
                <!-- ---------------------------------- -->
                            ...
                            <ul id="sidebarnav" class="text-gray-600 text-sm">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-100"
                                        ...
                                        <i class="ti ti-article  text-xl"></i> <span>Paket</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-100"
                                        href={{route("dashboard.courses.index")}}>
                                        <i class="ti ti-article  text-xl"></i> <span>Courses</span>
                                    </a>
                                </li>
                                @endrole
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-100"
                                        ...
                                        <i class="ti ti-article  text-xl"></i> <span>My Courses</span>
                                    </a>
                                </li>
                                @endrole
