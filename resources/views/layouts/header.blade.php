                ...
                <div class="card hs-dropdown-menu transition-[opacity,margin] border border-gray-400 rounded-[7px] duration hs-dropdown-open:opacity-100 opacity-0 mt-2 min-w-max  w-[200px] hidden z-[12]"
                    ...
                    <div class="card-body p-0 py-2">
                        <a href="{{route('profile.edit')}}"
                            class="flex gap-2 items-center px-4 py-[6px] hover:bg-blue-200 ">
                        ...
                        <form class="px-4 mt-[7px] grid" action="{{route('logout')}}" method="POST">
                            @csrf
                            <button type="submit" 
                                class="btn-outline-primary w-full hover:bg-blue-600 hover:text-white">Logout</button>
                        </form>
