        ...
        <div class="border border-gray-200 bg-white p-4 rounded-md">
            ...
            <div class="flex gap-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                @for($idx = 0; $idx < 6; $idx++)
                                    <label for="{{$idx}}-{{$i}}" class="p-2 rounded-md has-[:checked]:text-white has-[:checked]:bg-blue-400 cursor-pointer border">
                                        <span>{{$idx}}</span>
                                        <input id="{{$idx}}-{{$i}}" type="radio" {{$answer->is_correct == $idx ? 'checked' : ''}}  name="{{$i}}" value={{$idx}} class="hidden">
                                    </label>
                                @endfor
                ...
                <div class="flex flex-col mt-4 gap-2">
                    ...
                    <textarea name="discussion" class="editor rounded-md border-gray-200 w-full" name="" id="" cols="100" rows="8">{{$courseQuestion->discussion}}</textarea>
                </div>
            </div>
        </div>
    </form>
